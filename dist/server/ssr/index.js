...
var client_references_default = {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-C2Aljhi_.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"8f7ba5393f33": async () => {
		const m = await import("./assets/error-boundary-C49zV0vW.js");
		return {
			get "ErrorBoundary"() {
	...
	"ee6cb3d92c61": async () => {
		const m = await import("./assets/layout-segment-context-CL7h_qhP.js");
...
//#endregion
export { require_react as a, __toCommonJS as c, app_ssr_entry_default as default, handleSsr, useRouter as i, __toESM as l, getLayoutSegmentContext as n, __esmMin as o, usePathname as r, __exportAll as s, require_jsx_runtime as t };
